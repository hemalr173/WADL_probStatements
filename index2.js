...
app.get("/addDocs", async (req, res) => {
  try {
    const result = await musicArt.insertMany([
      {
        Songname: "yeh janwani hai dewani",
        Film: "YJHD",
        Music_director: "Sonam kapoor",
        Singer: "armaan malik",
      },
      {
        Songname: "hum sath sath hai",
        Film: "hum sath sath hai",
        Music_director: "Sohali",
        Singer: "armaan malik",
      },
    ]);
    console.log(result);
...
app.get("/display", async (req, res) => {
  try {
    ...
    let html =
      "<table border='1'><tr><th>MusicName</th><th>Film</th><th>Music_director</th><th>Singer</th></tr>";
